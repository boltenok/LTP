"""A board is a list of lists of str. For example, the board
    ANTT
    XSOB
...
def make_str_from_column(board, column_index):
    ...
    'NS'
    """
    column_list = []                                        # Create an empty list to put extracted characters in
    for each_list_item in board:                            # Going through each item of the given list in board, pull the target item
        column_list.append(each_list_item[column_index])    # and place pulled item in the empty list
...
# print(word_score('DRUDRY'))
# print(word_score('DRUDGERYYYY'))
# print(word_score('DR'))
...
def update_score(player_info, word):
    ...
    ['Jonathan', 7]
    """
    return [player_info[0], (player_info[1] + word_score(word))]
